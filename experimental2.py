...
def main():
    ...
    corpus1_tfidf = [tfidf_model1[doc] for doc in corpus1]  
    ...
    corpus2_tfidf = [tfidf_model2[doc] for doc in corpus2]  

    lda_model1 = run_lda(corpus1_tfidf, dictionary1)
    lda_model2 = run_lda(corpus2_tfidf, dictionary2)
